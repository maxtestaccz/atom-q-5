            ...
            <div className="grid flex-1 auto-rows-min gap-6 px-4">
              ...
              <div className="grid gap-3">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem key="create-easy" value="EASY">Easy</SelectItem>
                    <SelectItem key="create-medium" value="MEDIUM">Medium</SelectItem>
                    <SelectItem key="create-hard" value="HARD">Hard</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid gap-3">
              ...
              <div className="grid gap-3">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem key="create-draft" value="DRAFT">Draft</SelectItem>
                    <SelectItem key="create-active" value="ACTIVE">Active</SelectItem>
                    <SelectItem key="create-archived" value="ARCHIVED">Archived</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid gap-3">
            ...
            <div className="grid flex-1 auto-rows-min gap-6 px-4">
              ...
              <div className="grid gap-3">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem key="edit-easy" value="EASY">Easy</SelectItem>
                    <SelectItem key="edit-medium" value="MEDIUM">Medium</SelectItem>
                    <SelectItem key="edit-hard" value="HARD">Hard</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid gap-3">
              ...
              <div className="grid gap-3">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem key="edit-archived" value="ARCHIVED">Archived</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid gap-3">
